...
/** In correct XML the declaration is the first entry in the file.
	@verbatim
		<?xmlManager version="1.0" standalone="yes"?>
	@endverbatim
...
public:
    ...
    /**
    	...
    	specified, TinyXML-2 will assume 'xmlManager' points to a
    	null terminated string.
    */
    XMLError Parse( const char* xmlManager, size_t nBytes=static_cast<size_t>(-1) );
    ...
    */
    ...
    /**
    	...
    	declaration is used.:
    	@verbatim
    		<?xmlManager version="1.0" encoding="UTF-8"?>
    	@endverbatim
    */
